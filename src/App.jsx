    ...
    const [movies, setMovies] = useState([
        {
            ...
            rating: 5,
            trailerLink: 'https://www.youtube.com/embed/LKFuXETZUsI?si=stOrHVHUQiQ6DQZ2'
        },
        {
            title: 'Black Bag',
            ...
            rating: 4,
            trailerLink: 'https://www.youtube.com/embed/Du0Xp8WX_7I?si=AxPCI_WdbAmHMkV5'
        },
        {
    ...
    return (
        <div className='app'>
            <Routes>
                ...
                <Route path='/details/:movieName' element={<Details movies={movies}/>} />
            </Routes>
